...
Revision ID: 21195dc788a2
Revises: 
Create Date: 2021-12-08 16:50:09.768754
...
def upgrade():
    ...
    sa.Column('technnical_details', sa.String(length=255), nullable=True),
    ...
    op.create_table('ordem_statuses',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('status', sa.String(length=15), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=True),
