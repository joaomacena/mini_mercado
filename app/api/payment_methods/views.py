...
def create(payment_method: Payment_methodSchema, repository: Payment_methodRepository = Depends()):
...
@router.put('/{id}')
def update(id: int,payment_method:Payment_methodSchema, repository: Payment_methodRepository = Depends()):
